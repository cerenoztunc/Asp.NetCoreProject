...
namespace Project.MVC.ApiServices
{
    public class CategoryApiService
    {
        ...
        public async Task<IEnumerable<CategoryDto>> GetAllAsync()
        {
            ...
            if (response.IsSuccessStatusCode) categoryDtos = JsonConvert.DeserializeObject<IEnumerable<CategoryDto>>(await response.Content.ReadAsStringAsync());
